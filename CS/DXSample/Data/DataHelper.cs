    ...
    public class DataHelper {
        ...
        public static AppointmentEntity RR() {
            ...
            var appt = new AppointmentEntity() {
                ...
                Label = 3,
                Description =
                "Nothing to do but relax and enjoy the day with family. Need to take my foot off the gas pedal and enjoy the day.",
            };
            return appt;
        }
        ...
        public static AppointmentEntity ConferenceCompanyMeeting() {
            ...
            var appt = new AppointmentEntity() {
                ...
                Label = 1,
                Description =
                "Everyone must be ready to ask questions and inform leadership team why they are not performing as expected and what we need to do as a team to improve morale.",
            };
            return appt;
        }
        ...
        public static AppointmentEntity ConferenceCustomerRetentionReview() {
            ...
            var appt = new AppointmentEntity() {
                ...
                Label = 1,
                Description =
                "Discuss ways in which we can improve our relationship with customers and prove to them that we are the long term source for all their A/V needs.",
            };
            return appt;
        }
        ...
        public static AppointmentEntity ConferenceDatabaseAndWebsiteReview() {
            ...
            var appt = new AppointmentEntity() {
                ...
                Label = 1,
                Description =
                "It's time to launch our new website. Management can no longer tolerate delays nor accept excuses. We've been waiting long enough for the overhaul.",
            };
            return appt;
        }
        ...
        public static AppointmentEntity TrainingTrainStaffOnNewRemoteControls() {
            ...
            var appt = new AppointmentEntity() {
                ...
                Label = 2,
                Description =
                "Our newest remote controls are ready for production. Everyone needs to understand how our new universal remote works and our long term plans for better automation."
            };
            return appt;
        }
