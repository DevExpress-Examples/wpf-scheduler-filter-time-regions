...
Namespace DXSample
    ...
    Public Class SchedulingViewModel
        ...
        Protected _Appts As ObservableCollection(Of AppointmentEntity) = New ObservableCollection(Of AppointmentEntity)()
        ...
        Protected _Calendars As ObservableCollection(Of ResourceEntity) = New ObservableCollection(Of ResourceEntity)()
        ...
        Public Sub New()
            ...
            Call DataHelper.Gym().ForEach(Sub(c) Appts.Add(c))
